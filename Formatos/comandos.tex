...
% =========================================================
% CONTADOR PERSONALIZADO PARA ANEXOS
% =========================================================
\newcounter{anexo}
...
\newcommand{\crearanexo}[2]{%
    ...
    \nombreCapituloCabecera{RH}{Anexo \theanexo\ - #1}
...
% =========================================================
% BLOQUES DE CÓDIGO ESTILO GITHUB SIN MINTED
% =========================================================

\definecolor{githubBg}{RGB}{246,248,250}
...
\newtcblisting{bashbox}{
    ...
    top=1mm,
    bottom=1mm,
    listing options={style=githubbash}
}
...
\newtcblisting{configbox}{
    ...
    top=1mm,
    bottom=1mm,
    listing options={style=githubconfig}
}
...
% Activar/desactivar el comportamiento de libro
\booklayoutfalse      % <-- Artículo (actual)
%\booklayouttrue      % <-- Libro (capítulos en páginas impares)
