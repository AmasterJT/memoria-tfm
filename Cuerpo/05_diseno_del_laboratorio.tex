...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Imagenes/esquema-detallado-redes-VMware-interfaces.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/segmentacion-red-vmware.png}
