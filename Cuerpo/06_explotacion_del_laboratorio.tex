...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagenes/portal_interno.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagenes/leak-databas-tickets.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagenes/RDP.png}
