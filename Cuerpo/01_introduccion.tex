...
La memoria se estructura en siete capítulos principales. En primer lugar, se presenta el contexto del trabajo, los objetivos perseguidos y el alcance del proyecto. Posteriormente, se describe la metodología empleada, la planificación realizada y los recursos utilizados durante el desarrollo.
